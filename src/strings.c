...
const u8 gText_ExpandedPlaceholder_Aqua[] = _("Frost");
...
const u8 gText_ProfBirchMatchCallName[] = _("Prof. Sequioa");
...
const u8 gText_MainMenuMysteryEvents[] = _("Mystery Ecents");
...
const u8 gText_DexHoennTitle[] = _("Sol Dex");
...
const u8 gText_DexSortLightestTitle[] = _("Light Mode");
...
const u8 gText_DexHoennDescription[] = _("Sol region's Pokédex");
...
const u8 gText_HOFDexRating[] = _("Spotted Pokémon: {STR_VAR_1}!\nOwned Pokémon: {STR_VAR_2}!\pProf. Sequoia's Pokédex rating!\pProf. Sequoia: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("Prof. Sequoia is in trouble!\nRelease a Pokémon and rescue him!");
...
const u8 gText_LanettesPC[] = _("Lannete's PC");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Sol region.");
...
const u8 gText_ReturnToConditionMenu[] = _("Return to the continue menu.");
...
const u8 gText_Questionnaire[] = _("Questionnare");
