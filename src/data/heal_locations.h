static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GLORIA_TOWN - 1] = {MAP_GROUP(GLORIA_TOWN), MAP_NUM(GLORIA_TOWN), 9, 13},
    [HEAL_LOCATION_SUNVIEW_TOWN - 1] = {MAP_GROUP(SUNVIEW_TOWN), MAP_NUM(SUNVIEW_TOWN), 16, 11},
    [HEAL_LOCATION_JOYVALE_CITY - 1] = {MAP_GROUP(JOYVALE_CITY), MAP_NUM(JOYVALE_CITY), 14, 21},
};
